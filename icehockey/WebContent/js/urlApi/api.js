...
const TEACHCLUBandTeamURL=IPCONFIG+'TeachteamServlet';//执教俱乐部url
...
const MYACTIVITYURL=IPCONFIG+'MyActivityServlet';//装备url
const MYPHOTOURL=IPCONFIG+'MyPhotoServlet';//装备url