...
<link rel="stylesheet" href="../../css/personinfo/experience.css">
			...
			<thead>
				<c:choose>
					<c:when test="${!empty experiences}">
						...
						<c:forEach items="${experiences}" var="o" varStatus="st">
							<tr>
								<td align="center">${o.onDate }</td>
								<td align="center">${o.organizationName }</td>
								<td align="center">${o.organizationDegree }</td>
							</tr>
						</c:forEach>
					</c:when>
					<c:otherwise>
